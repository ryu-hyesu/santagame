...
public class ChatSystem : MonoBehaviour
{
   ...
   int beforeNpc = 5;
    ...
    public static ChatSystem GetInstance(){ //다른 데서 쓸 수 있음.
        return instance;
    }
    ...
    public void Ondialogue(TextAsset inkJSON, Transform[] chatPos)
    {
        ...
        //et.sizeDelta = new Vector2(10.0f, 10.0f);
        ...
        /*if(scene.name == "ch3_dialogue")
        {
            ret.offsetMin = new Vector2(0,0);
            ret.offsetMax = new Vector2(50-Screen.width, 50-Screen.height);
        }*/
    ...
    public void DialogueFlow()
    {
        ...
        if(currentStory.canContinue){
            ...
            //DisplayChoices();
            if(scene.name != "ch3_dialogue" && scene.name != "ch3_game" && scene.name != "street" && scene.name != "New Scene" && scene.name != "cake" && scene.name != "SHIP" && scene.name != "EndShip" )
                ShowChoices();
    ...
    /*
    public static implicit operator ChatSystem(chatsys v)
    {
